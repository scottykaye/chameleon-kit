...
;
;
async function collectSegmentData(flightRouterState, seedData, fullPageDataBuffer, staleTime, clientModules, serverConsumerManifest) {
    ...
    const tree = await collectSegmentDataImpl(flightRouterState, seedData, fullPageDataBuffer, clientModules, serverConsumerManifest, '', '', resultMap);
...
async function collectSegmentDataImpl(route, seedData, fullPageDataBuffer, clientModules, serverConsumerManifest, segmentPathStr, accessToken, segmentBufferMap) {
    ...
    for(const parallelRouteKey in children){
        ...
        const childTree = await collectSegmentDataImpl(childRoute, seedData, fullPageDataBuffer, clientModules, serverConsumerManifest, childSegmentPathStr, childAccessToken, segmentBufferMap);
...
async function PrefetchTreeData({ fullPageDataBuffer, serverConsumerManifest, treePrefetch }) {
    ...
    await Promise.race([
        ...
        // this case.
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$lib$2f$scheduler$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["waitAtLeastOneReactRenderTask"])()
    ]);
...
//# sourceMappingURL=08b5e_next_dist_35c67e._.js.map