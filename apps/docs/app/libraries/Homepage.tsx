  ...
  return (
    <SidebarWrapper size={size as string}>
      <Sidebar
        ...
        className="bg-surface-200 border-r border-primary-500 p-2 flex flex-col items-start"
      >
        <header>
          <svg
        ...
        <menu className="grow">
          ...
          <li>
            ...
            <menu>
              <li>
                <Link href="/">Chameleon Kit</Link>
              </li>
              <li>
                <Link href="https://theme-handler-docs.vercel.app/">
                  Theme Handler
                </Link>
              </li>
              <li>
                <Link href="https://github.com/scottykaye/accessible-navigation">
          ...
          <li>
            <Link href="https://github.com/chameleon-kit">Github Link</Link>
          </li>
        </menu>
